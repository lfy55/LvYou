...
import com.sqk.dao.CommentDao;
import com.sqk.dao.RevertDao;
...
public class sendComment extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		Boolean flag = commentDao.sendComment(user, content, tId);
		response.getOutputStream().write(flag.toString().getBytes("UTF-8"));
