...
public class searchNearServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public searchNearServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		jsonString = gpsDao.searchNearUser(user);
		System.out.println("返回给客户端的附近用户json串："+jsonString.toString());
